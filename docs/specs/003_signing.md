...
All message types include an optional `context` field for binding to external protocols. See [Protocol Integration](006_integration.md) for details.
...
This attack is formalized in `Proofs/Soundness/Soundness.lean` as the `nonce_reuse_key_recovery` theorem. See [Verification: Special Soundness](004_verification.md#special-soundness) for the formal proof.
...
See [Protocol Integration](006_integration.md) for detailed usage patterns with external consensus protocols.
